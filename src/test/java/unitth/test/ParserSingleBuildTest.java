...
public class ParserSingleBuildTest {
   ...
   public static void beforeAll() throws Exception {
      ...
      System.out.println("File; "+new File(thr.getClass().getResource("/test-junitReport-01.xml").getFile()));
   ...
   @Test
   public void skippedTests() throws Exception {
      assertEquals("Checking the no of skipped tests.", 2, tr.getNoSkippedTests());
   }

   @Test
   public void skippedTestsInSuite() throws Exception {
      assertEquals("Checking the no of skipped tests in suite.", 1, tr.getSuiteByName("a.b.c.Test1").getNoSkippedTests());
      assertEquals("Checking the no of skipped tests in suite.", 1, tr.getSuiteByName("a.b.c.Test2").getNoSkippedTests());
   }
}
